...
This section documents the CLI tools installed by the bootstrap.
...
## Rust and TOML Tooling

- [rust-analyzer](rust-analyzer.md)
- [taplo](taplo.md)

## Shell and Markup Tooling
